...
add_filter('pt-ocdi/import_files', 'store_import_files');

function store_after_import_setup()
{
...
add_action('pt-ocdi/after_import', 'store_after_import_setup');